...
function App() {
  return ( 
    <div>
     ...
     <ul>
     <li><NavLink to='/Gym-react' className='link'>Home</NavLink></li>
    ...
    <div className="App">
    <Routes>
       <Route exact path='/Gym-react' element={<Content/>} />
       <Route eaact path='/info' element={<Information/>}/>
       <Route eaact path='/help' element={<Help/>}/>
    </Routes>
    </div>
    </Router>
    <footer>
